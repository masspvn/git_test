...
rainy_days_col = [int(month["rainy_days"]) for month in monthly_weather]
month_col = [month["month"] for month in monthly_weather]
print(month_col[rainy_days_col.index(max(rainy_days_col))])
